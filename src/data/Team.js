...
Week 0: Free Agent
  ...
  Week 14: Philadelphia Eagles, Indianapolis Colts, Miami Dolphins, New England Patriots`.split(/\n/).map(week=>week.split(': ')).reduce((teams,info)=>{
      //console.log(info)
...
export class Teams {
    constructor(teams){
        //console.log(byes)
        const list = Array.isArray(teams) ? teams.map(t=>new Team({short: t.Team, full: t.FullTeam})) : null
        this.list = list
